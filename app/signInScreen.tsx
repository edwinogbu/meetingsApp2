...
const SignInScreen = () => {
  ...
  const onSignInPress = async () => {
    ...
    try {
      ...
      if (response?.error) {
        setError(response.msg || "Invalid credentials, please try again.");
        return;
      }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <Text style={styles.signupText}>
          ...
          <Text style={styles.signupLink} onPress={() => router.replace("/signUpScreen")}>
            {" "} Signup
          </Text>
        </Text>
      </View>
...
//   const login = authContext?.login; // ✅ Use optional chaining
...
//     if (!login) {
//       setError("Login function is unavailable. Please try again.");
//       setLoading(false);
//       return;
//     }

//     try {
//       const response = await login(form.email, form.password); // ✅ Safe login call
//       if (response?.error) {
...
//   logoContainer: {
//     backgroundColor: "#FFFFFF",
//     borderRadius: 50, // ✅ Fixed borderRadius
//     padding: 5,
//   },
//   logo: {
//     width: 80,
...
//   const router = useRouter();
//   const authContext = useAuth();
//   const onLogin = authContext?.onLogin; // ✅ Ensures safe access to login function
...
//     try {
//       const response = await onLogin(form.email, form.password); // ✅ Safe login call
//       if (response?.error) {
//         setError(response.msg);
//       } else {
//         console.log("Login successful:", response);
...
//     backgroundColor: "#FFFFFF",
//     borderRadius: 40,
//     overflow: "hidden", // ✅ Ensures proper borderRadius rendering
//   },
//   logo: {
//     width: 80,
//     height: 80,
